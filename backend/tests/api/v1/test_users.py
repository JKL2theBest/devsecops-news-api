...
async def test_get_users_authorized(user_client: AsyncClient) -> None:
...
async def test_update_own_profile(user_client: AsyncClient) -> None:
...
async def test_update_other_profile_forbidden(user_client: AsyncClient, author_client: AsyncClient) -> None:
...
async def test_admin_can_update_and_delete_user(admin_client: AsyncClient, user_client: AsyncClient) -> None:
    ...
    update_response = await admin_client.patch(
        f"/api/v1/users/{user_id_to_modify}",
